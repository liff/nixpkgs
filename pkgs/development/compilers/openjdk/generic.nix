...
stdenv.mkDerivation (finalAttrs: {
  ...
  ++ lib.optionals (featureVersion == "11") [
    ./11/patches/xdg-basedir.patch
  ]
  ++ lib.optionals (featureVersion == "17" || featureVersion == "19") [
    ./17/patches/xdg-basedir.patch
  ]
  ++ lib.optionals (featureVersion == "20") [
    ./20/patches/xdg-basedir.patch
  ]
  ++ lib.optionals (featureVersion == "21") [
    ./21/patches/xdg-basedir.patch
  ]
  ++ lib.optionals (featureVersion == "25") [
    ./25/patches/xdg-basedir.patch
  ];
